  ...
  return (
    <div className="resume-container" >
      <div className="resume-top-nav"  >
        ...
        <button style={{ color: 'black', backgroundColor: 'whitesmoke' }} type="button" className="download-btn" onClick={downloadPdf}>
          <FiDownload /> Download
        </button>
        <button
          style={{ color: 'black', backgroundColor: 'whitesmoke' }}
      ...
      <div className="resume-nav-div">
        ...
        <div style={{ color: 'black', backgroundColor: 'whitesmoke', padding: '5px' }} className="page-indicator">
          Page {currentPage} of {NUM_PAGES}
        </div>
        <button
          style={{ color: 'black', backgroundColor: 'whitesmoke' }}
          type="button"
