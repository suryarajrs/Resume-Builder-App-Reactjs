...
function EducationForm({ index }) {
  ...
  const education = useFormStore((state) => state.education[index]); // Access sections
  const setEducationAt = useFormStore((state) => state.setEducation); // Access setSections

  const bullets = useFormStore((state) => state.education[0].bullets);
  const setEducationBullets = useFormStore((state) => state.setEducationBullets); // Access setSections
...
function Education() {
  ...
  const educationArray = useFormStore((state) => state.education); // Access sections
  const setEducationArray = useFormStore((state) => state.setEducationArray); // Access setSections
