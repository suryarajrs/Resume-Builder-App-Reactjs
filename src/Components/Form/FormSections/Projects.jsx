...
function ProjectForm({ index }) {
  ...
  const project = useFormStore((state) => state.projects[index]);
const setProjectAt = useFormStore((state) => state.setProject);



  const bullets = useFormStore((state) => state.projects[index].bullets);
const setProjectBullets = useFormStore((state) => state.setProjectBullets);
...
function Projects() {
  ...
  const projects = useFormStore((state) => state.projects);
  const setProjectArray = useFormStore((state) => state.setProjectArray);
