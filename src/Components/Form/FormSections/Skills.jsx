  ...
  return (
    <>
      ...
      <div className="skill-add-div">
        <button style={{background:'black',color:'white'}} type="button" className="skill-add-btn" onClick={addInput}>Add more</button>
      </div>
    </>
  );
}
...
const setIsSimple = useFormStore((state) => state.setIsSimple);
